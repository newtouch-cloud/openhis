...
namespace Newtouch.EMR.Repository
{
    ...
    /// 描 述：住院患者信息
    /// </summary>
    public class bl_ryblRepo : RepositoryBase<bl_ryblEntity>, Ibl_ryblRepo
    {
        /// <summary>
        /// 默认构造函数
        /// </summary>
        /// <param name="databaseFactory">EF上下文工厂</param>
        public bl_ryblRepo(IDefaultDatabaseFactory databaseFactory)
        ...
        public bl_ryblEntity bl_ryblGetByID(string  ID)
        {
        ...
        public void SubmitForm(bl_ryblEntity entity, string keyValue)
        {
