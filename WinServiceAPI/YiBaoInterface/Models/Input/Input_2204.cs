...
{
    public class Input_2204 : InputBase
    {
        public List<feedetail2204>feedetail { get; set; }

    }

    public class feedetail2204
    {
        /// <summary>
        ...
        /// <summary>
        /// 输入-扩展参数（参数标识：exp_content）扩展参数 字符型 4000 Y 用于扩展出更多的参数，格式为 JSON 格式的字符串，具体内容见下面的扩展参数定义。
        /// </summary>
    ...
    {
        /// <summary>
        /// 急诊标志 字符型 6  0、 非急诊；1、急诊；2、术前门诊检查；3、择期手术项目
        /// </summary>
