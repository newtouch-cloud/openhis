...
{
    public class Output_2208 : OutputBase
    {
        public setlinfo2208 setlinfo { get; set; }
    ...
    public class setlinfo2208
    {
        ...
        /// <summary>
        /// 23|个人账户共济支付金额|数值型|16,2||Y|
        /// </summary> 
        public string acct_mulaid_pay { get; set; }

        /// <summary>
        /// 24|医院负担金额|数值型|16,2||Y|
        /// </summary> 
		public string hosp_part_amt { get; set; }

        /// <summary>
        /// 25|医药机构结算ID|字符型|30||Y|存放发送方报文ID
        /// </summary> 
		public string medins_setl_id { get; set; }

        /// <summary>
        /// 26|个人现金支出|数值型|16,2|  |Y|  
        /// </summary> 
		public string pdn_cash_pay { get; set; }
    }
