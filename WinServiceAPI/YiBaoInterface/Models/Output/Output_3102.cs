...
{
    public class Output_3102 : OutputBase
    {
        //输出-违规信息（节点标识：result）
        public List<Outputrs3102> result { get; set; }
        //输出-违规明细信息（节点标识：judge_result_detail_dtos）
        public List<OutputJRDD3102> judge_result_detail_dtos { get; set; }
    }
    //输出-违规信息（节点标识：result）
    public class Outputrs3102 {
