...
{
   public class Input_3401:InputBase
    {
        public Deptinfo3401 deptinfo { get; set; }
    }

    public class Deptinfo3401
    {
        /// <summary>
        ...
        /// <summary>
        /// 3|hosp_dept_name|医院科室名称|字符型|100
        /// </summary>
        public string hosp_dept_name { get; set; }

        /// <summary>
        /// 4|begntime|开始时间|日期时间型|
        /// </summary>
        public string begntime { get; set; }

        /// <summary>
        /// 5|endtime|结束时间|日期时间型|
        /// </summary>
        ...
        /// <summary>
        /// 7|dept_resper_name|科室负责人姓名|字符型|50
        /// </summary>
        public string dept_resper_name { get; set; }

        /// <summary>
        /// 8|dept_resper_tel|科室负责人电话|字符型|50
        /// </summary>
        public string dept_resper_tel { get; set; }

        /// <summary>
        /// 9|dept_med_serv_scp|科室医疗服务范围|字符型|500
        /// </summary>
        public string dept_med_serv_scp { get; set; }

        /// <summary>
        /// 10|dept_estbdat|科室成立日期|日期时间型|
        /// </summary>
