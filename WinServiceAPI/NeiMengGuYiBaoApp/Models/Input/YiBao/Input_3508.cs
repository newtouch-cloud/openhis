...
{
    public class Input_3508 : InputBase
    {
        public Data3508 data { get; set; }
    }

    public class Data3508
    {
        /// <summary>
        /// 1|定点医药机构编号|字符型|30|Y|
        /// </summary>
        ...
        /// <summary>
        /// 6|定点医药机构商品库存流水号|字符型|30|
        /// </summary>
        public string medins_prod_inv_no { get; set; }
        ...
        /// <summary>
        /// 14|生产日期|日期型|yyyy-MM-dd|
        /// </summary>
        public string manu_date { get; set; }

        /// <summary>
        /// 15|有效期止|日期型|yyyy-MM-dd|
        /// </summary>
