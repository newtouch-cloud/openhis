...
namespace NeiMengGuYiBaoApp.Models.Input.YiBao
{
    ...
    {
        public string fixmedins_mdt_rt_id { get; set; }  // 医药机构就诊ID (必填, 字符型 30)
        ...
        public DateTime? begntime { get; set; }  // 开始时间 (必填, 日期型 yyyy-MM-dd HH:mm:ss)
        public DateTime? endtime { get; set; }  // 结束时间 (日期型 yyyy-MM-dd HH:mm:ss)
        ...
        public decimal? ipt_days { get; set; }  // 住院天数 (数值型 16)
        ...
        public decimal? fetts { get; set; }  // 胎次 (数值型 3)
        public decimal? fetus_cnt { get; set; }  // 胎儿数 (数值型 3)
        public string pret_flag { get; set; }  // 早产标志 (字符型 3)
        public DateTime? prey_time { get; set; }  // 妊娠时间 (日期型 yyyy-MM-dd)
        ...
        public DateTime? opt_time { get; set; }  // 经办时间 (日期型 yyyy-MM-dd HH:mm:ss)
    ...
    public class OwnPayPatnDiagListD
    {
        ...
        public DateTime? diag_time { get; set; }  // 诊断时间 (日期型 yyyy-MM-dd HH:mm:ss)
