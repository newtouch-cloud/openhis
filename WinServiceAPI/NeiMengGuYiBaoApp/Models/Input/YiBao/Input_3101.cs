...
{
    public class Input_3101 : InputBase
    {
        //输入-规则分析信息（节点标识：data）
        public InputData3101 data { get; set; }
        ////输入-参保人信息（节点标识：patient_dtos）
        //public InputPD3101 patient_dtos { get; set; }
        ////输入-就诊信息（节点标识：fsi_encounter_dtos）
        //public InputFED3101 fsi_encounter_dtos { get; set; }
        ////输入-诊断信息（节点标识：fsi_diagnose_dtos）
        //public InputFDD3101 fsi_diagnose_dtos { get; set; }
        ////输入-处方（医嘱）信息（节点标识：fsi_order_dtos）
        //public InputFOD3101 fsi_order_dtos { get; set; }
        ////输入-手术操作信息（节点标识：fsi_operation_dtos）
        //public InputFODSS3101 fsi_operation_dtos { get; set; }
    }
    //输入-规则分析信息（节点标识：data）
    public class InputData3101
    {
        //参保人信息	参保人信息集合
        //public string patient_dtos { get; set; }
        public List<InputPD3101> patient_dtos { get; set; }
        //规则标识集合	规则标识集合
    ...
    public class InputPD3101
    {
        ...
        public List<InputFED3101> fsi_encounter_dtos { get; set; }
        //	医院信息集合	医院信息集合		
        //public string fsi_his_data_dto { get; set; }

    }
    //输入-就诊信息（节点标识：fsi_encounter_dtos）
    public class InputFED3101
    {
        ...
        public List<InputFDD3101> fsi_diagnose_dtos { get; set; }
        //	医师标识	字符型	20	医生唯一ID
        ...
        public List<InputFOD3101> fsi_order_dtos { get; set; }
        //	生育状态	字符型	3	参考字典表
