...
namespace NeiMengGuYiBaoApp.Service
{
    ...
    /// 国家医保的实现-V1.24
    /// </summary>
    public static class YiBaoHelper
    {
        /// <summary>
        ...
        */
        ...
        private static void SettingsBase(PostBase post, DateTime getdate, InputPost<InputBase> input)
        {
        ...
        private static string GetRecerSysCode(PostBase post, InputPost<InputBase> input)
        {
            /*
        ...
        private static string DoSigin(string operatorId, string operatorName)
        {
            ...
            string code = "1";
            string oprs = CallAndSaveLog(input, out output, post, out code);
        ...
        */
        ...
        public static string CallAndSaveLog<I, O>(I InModle, out O OutModlem, PostBase post, out string code)
          where O : OutputBase
          where I : InputBase
        {
            ...
            else
            {
                ...
                switch (post.tradiNumber)
                {
                    ...
                    case "2401":
                        ...
                        break;
                    case "1101":
                        test = "{\"infcode\": 0, \"output\": {\"baseinfo\": {\"certno\": \"310103197307252018\", \"psn_no\": \"801874939\", \"gend\": \"1\", \"naty\": \"99\", \"expContent\": null, \"brdy\": \"1998-01-01\", \"psn_cert_type\": \"01\", \"psn_name\": \"阿炳\", \"age\": 25.2}, \"insuinfo\": [{\"insuplc_admdvs\": \"310115\", \"psn_insu_date\": \"1998-01-01\", \"cvlserv_flag\": \"0\", \"balc\": 41509.00, \"emp_name\": \"乌兰察布医院\", \"psn_type\": \"116032\", \"psn_insu_stas\": \"1\", \"insutype\": \"310\", \"paus_insu_date\": null}]}, \"idetinfo\": [], \"warn_msg\": null, \"cainfo\": null, \"err_msg\": null, \"refmsg_time\": \"20230920182350513\", \"signtype\": null, \"respond_time\": \"20230920182350662\", \"inf_refmsgid\": \"310000202309201823500002516630\"}\r\n";
