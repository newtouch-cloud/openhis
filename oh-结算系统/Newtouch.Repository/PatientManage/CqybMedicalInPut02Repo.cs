...
{
    public class CqybMedicalInPut02Repo : RepositoryBase<CqybMedicalInPut02Entity>, ICqybMedicalInPut02Repo
    {
        public CqybMedicalInPut02Repo(IDefaultDatabaseFactory databaseFactory)
        ...
        public void SaveCqybMedicalS02InReg(CqybMedicalInPut02Entity Entity, string keyValue)
        {
