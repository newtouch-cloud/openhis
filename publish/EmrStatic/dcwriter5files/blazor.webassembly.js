(() => {
                    ...
                    return ut = c, ct = a, lt = s, dt = m, {
                        ...
                        postRun: [() => {
                            ...
                            dt.Blazor = {
                                ...
                                function () {
                                    const t = wt("DCSoft.WASM", "DCSoft.WASMJSRuntime", "InvokeDotNet"),
                                        n = wt("DCSoft.WASM", "DCSoft.WASMJSRuntime", "BeginInvokeDotNet"),
                                        r = wt("DCSoft.WASM", "DCSoft.WASMJSRuntime", "EndInvokeJS"),
                                        o = wt("DCSoft.WASM", "DCSoft.WASMJSRuntime", "NotifyByteArrayAvailable");
                                    e.attachDispatcher({
    ...
    async function Vt(t) {
        ...
        Kt = !0,
            function () {
                if (window.parent !== window && !window.opener && window.frameElement) {
                    const e = window.sessionStorage && window.sessionStorage["DCSoft.v20241028"],
                        t = e && JSON.parse(e);
                ...
                e.invokeMethod("DCSoft.WASM", "ApplyHotReloadDelta", t, n, r, o)
            }, Ke._internal.getApplyUpdateCapabilities = () => e.invokeMethod("DCSoft.WASM", "GetApplyUpdateCapabilities"), Ke._internal.invokeJSFromDotNet = Gt, Ke._internal.endInvokeDotNetFromJS = Xt, Ke._internal.receiveByteArray = Yt, Ke._internal.retrieveByteArray = qt;
        const n = Ge(yt);
        ...
        Ke._internal.navigationManager.getUnmarshalledBaseURI = () => ct.js_string_to_mono_string(r()), Ke._internal.navigationManager.getUnmarshalledLocationHref = () => ct.js_string_to_mono_string(o()), Ke._internal.navigationManager.listenForNavigationEvents((async (t, n, r) => {
            await e.invokeMethodAsync("DCSoft.WASM", "NotifyLocationChanged", t, n, r)
        }), (async (t, n, r, o) => {
            const s = await e.invokeMethodAsync("DCSoft.WASM", "NotifyLocationChangingAsync", n, r, o);
