...
from [NewtouchHIS_Base]..V_S_Sys_Organize where zt = '1' and Id in (
...
WHERE zt='1'
    ...
    WHERE zt='1'
            AND userId = 
        (SELECT Id
        FROM NewtouchHIS_Base..[Sys_User]
        WHERE zt='1'
                AND Account=@account
