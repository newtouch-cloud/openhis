...
select ghnm from mz_gh(nolock) where mzh = @mzh and zt = '1' and OrganizeId = @orgId
            ...
            , string outTradeNo = null)
        {
            ...
            if (ybfeeRelated != null || xnhybfeeRelated != null)
            {
                if (ybfeeRelated != null)
                {
                    if (ybfeeRelated.ybdlx == "chongqing" && !string.IsNullOrEmpty(ybfeeRelated.jylsh))
                    {
                        var ybFeeEntity = new CqybSett05Entity()
                        {
                            ...
                            jylsh = ybfeeRelated.jylsh,
                            cqtczf = ybfeeRelated.cqtczf,
                            zhzf = ybfeeRelated.zhzf,
                            gwybz = ybfeeRelated.gwybz,
                            cqxjzf = ybfeeRelated.cqxjzf,
                            delpje = ybfeeRelated.delpje,
                            lsqfxgwyff = ybfeeRelated.lsqfxgwyff,
                            zhye = ybfeeRelated.zhye,
                            dbzddyljgdz = ybfeeRelated.dbzddyljgdz,
                            mzjzje = ybfeeRelated.mzjzje,
                            mzjzmzye = ybfeeRelated.mzjzmzye,
                            ndyxmzfje = ybfeeRelated.ndyxmzfje,
                            ybzlzfs = ybfeeRelated.ybzlzfs,
                            shjzjjzfs = ybfeeRelated.shjzjjzfs,
                            bntczflj = ybfeeRelated.bntczflj,
                            bndezflj = ybfeeRelated.bndezflj,
                            tbqfxzflj = ybfeeRelated.tbqfxzflj,
                            ndyxmlj = ybfeeRelated.ndyxmlj,
                            bnmzjzzyzflj = ybfeeRelated.bnmzjzzyzflj,
                            bcqfxzfje = ybfeeRelated.bcqfxzfje,
                            bcjrybfwfy = ybfeeRelated.bcjrybfwfy,
                            ysfwzfs = ybfeeRelated.ysfwzfs,
                            yycbkkje = ybfeeRelated.yycbkkje,
                            syjjzf = ybfeeRelated.syjjzf,
                            syxjzf = ybfeeRelated.syxjzf,
                            gsjjzf = ybfeeRelated.gsjjzf,
                            gsxjzf = ybfeeRelated.gsxjzf,
                            gsdbzjgdz = ybfeeRelated.gsdbzjgdz,
                            gsqzfyy = ybfeeRelated.gsqzfyy,
                            qtbz = ybfeeRelated.qtbz,
                            syzhzf = ybfeeRelated.syzhzf,
                            gszhzf = ybfeeRelated.gszhzf,
                            bcjssfjkfpry = ybfeeRelated.bcjssfjkfpry,
                            jkfpyljj = ybfeeRelated.jkfpyljj,
                            jztpbxje = ybfeeRelated.jztpbxje,
                            pch = ybfeeRelated.pch,
                            bzbm=ybfeeRelated.bzbm,
                            bzmc=ybfeeRelated.bzmc,
                            yllb=ybfeeRelated.yllb,
                            jzlx=ybfeeRelated.jzlx,
                            jzpzm=ybfeeRelated.jzpzm,
							zt="1"
	                    };
	                    ybFeeEntity.Create();
                ...
                if (xnhybfeeRelated != null && xnhybfeeRelated.totalCost > 0)
                {
                    var xnhSett = new OutpatientXnhSettlementResultEntity
                    {
                        Id = Guid.NewGuid().ToString(),
                        OrganizeId = orgId,
                        jsnm = jszbEntity.jsnm,
                        outpId = mzghEntity.outpId,
                        jszt = 1,
                        accRedeem = xnhybfeeRelated.accRedeem.ToString(CultureInfo.InvariantCulture),
                        bottomRedeem = xnhybfeeRelated.bottomRedeem ?? "",
                        bottomSecondRedeem = xnhybfeeRelated.bottomSecondRedeem ?? "",
                        civilCost = xnhybfeeRelated.civilCost ?? "",
                        compensateCost = xnhybfeeRelated.compensateCost ?? "",
                        continentInsuranceCost = xnhybfeeRelated.continentInsuranceCost ?? "",
                        generalRedeem = xnhybfeeRelated.generalRedeem ?? "",
                        totalCost = xnhybfeeRelated.totalCost,
                        insuranceCost = xnhybfeeRelated.insuranceCost,
                        undulatingLine = xnhybfeeRelated.undulatingLine,
                        insureCost = xnhybfeeRelated.insureCost ?? "",
                        salvaCLCost = xnhybfeeRelated.salvaCLCost ?? "",
                        salvaFPCost = xnhybfeeRelated.salvaFPCost ?? "",
                        salvaJKCost = xnhybfeeRelated.salvaJKCost ?? "",
                        salvaJSCost = xnhybfeeRelated.salvaJSCost ?? "",
                        salvaMZCost = xnhybfeeRelated.salvaMZCost ?? "",
                        salvaYFCost = xnhybfeeRelated.salvaYFCost ?? "",
                        medicineCost = xnhybfeeRelated.medicineCost ?? "",
                        specialPovertyCost = xnhybfeeRelated.specialPovertyCost ?? "",
                        medicalAssistanceCost = xnhybfeeRelated.medicalAssistanceCost ?? "",
                        medicalSecondCost = xnhybfeeRelated.medicalSecondCost ?? "",
                    };
                    xnhSett.Create();
                    db.Insert(xnhSett);
                    if (xnhybfeeRelated.list != null && xnhybfeeRelated.list.Any())
                    {
                        var xnhSettResultList = new List<OutpatientXnhSettlementCalcDetailEntity>();
                        xnhybfeeRelated.list.ForEach(p =>
                        {
                            var item = new OutpatientXnhSettlementCalcDetailEntity
                            {
                                resultId = xnhSett.Id,
