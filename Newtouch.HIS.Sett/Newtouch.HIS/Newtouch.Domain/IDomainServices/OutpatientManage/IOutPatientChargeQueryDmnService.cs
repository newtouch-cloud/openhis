...
namespace Newtouch.HIS.Domain.IDomainServices
{
    ...
    public interface IOutPatientChargeQueryDmnService
    {
        ...
        /// <param name="createTimeEnd"></param>
        /// <returns></returns>
        IList<OutPatientRegChargeMVO> RegChargeQuery(Pagination pagination, string kh, string fph,string xm, string syy, DateTime? createTimestart, DateTime? createTimeEnd, DateTime? sfrqTimestart, DateTime? sfrqTimeEnd);
