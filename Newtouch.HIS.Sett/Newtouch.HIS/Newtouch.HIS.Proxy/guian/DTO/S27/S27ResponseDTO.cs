...
{
    /// <summary>
    /// 根据S18门诊上传返回的补偿序号outpId进行获取门诊结算单信息 返回报文
    /// </summary>
    public class S27ResponseDTO
    {
        /// <summary>
        /// 门诊补偿序号
        /// </summary>
        ...
        /// 就诊科室
        /// </summary>
        public string inpatientDepartmentsName { get; set; }
        ...
        /// 家庭账户余额
        /// </summary>
        public string accountLeftCost { get; set; }
        ...
        /// 合医二次补偿
        /// </summary>
        public decimal medicalSecondCost { get; set; }
