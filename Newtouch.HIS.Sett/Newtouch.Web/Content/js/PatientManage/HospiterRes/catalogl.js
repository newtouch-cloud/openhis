function mlbh(mlbh)
{
    ...
    switch (mlbh) {
        ...
        case "1308":
            colModel = [
                { label: '手术标准目录ID', name: 'OPRN_STD_LIST_ID', width: 100, align: 'left', hidden: true },
                 { label: '章', name: 'CPR', width: 30, align: 'left' },
        ...
        case "1901":
            colModel = [
                { label: '字典类型', name: 'type', width: 150, align: 'left' },
                { label: '字典标签', name: 'label', width: 100, align: 'left' },
                { label: '字典键值', name: 'value', width: 100, align: 'left' },
                { label: '父字典键值', name: 'parent_value', width: 100, align: 'left' },
                { label: '序号', name: 'sort', width: 60, align: 'left' },
                { label: '权限标识', name: 'vali_flag', width: 60, align: 'left' },
                { label: '创建账户', name: 'create_user', width: 60, align: 'left' },
                { label: '创建时间', name: 'create_date', width: 100, align: 'left' },
                { label: '版本号', name: 'version', width: 60, align: 'left' }
            ];
            break;
