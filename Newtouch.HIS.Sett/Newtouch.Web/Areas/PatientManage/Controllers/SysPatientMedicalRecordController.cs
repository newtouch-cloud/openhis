...
namespace Newtouch.HIS.Web.Areas.PatientManage.Controllers
{
    ...
    public class SysPatientMedicalRecordController : ControllerBase
    {
        ...
        public  ActionResult HealthyUpload()
        {
            return View();
        }
        ...
        /// <returns></returns>
        public ActionResult GetHealthUpload(Pagination pagination,DateTime ksrq,DateTime jsrq,string tabname)
        {
            var list = _sysPatientMedicalRecordDmnService.GetHealthUpload(pagination, ksrq, jsrq, tabname, this.OrganizeId);
            var data = new
            {
                rows = list,
