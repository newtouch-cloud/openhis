...
{
    public interface ISysPharmacyWindowDmnService
    {
        SysPharmacyWindowVO GetFormJson(string orgId, int? yfckId);
        void submitForm(SysPharmacyWindowVO entity, int? keyValue);
