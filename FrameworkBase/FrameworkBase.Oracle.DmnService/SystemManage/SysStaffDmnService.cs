...
namespace FrameworkBase.Oracle.DmnService
{
    ...
    public sealed class SysStaffDmnService : DmnServiceBase, ISysStaffDmnService
    {
        ...
        public IList<SysStaffVO> GetPaginationStaffList(Pagination pagination, string keyword)
        {
            ...
            sql.Append(@"select a.""Id"",a.""gh"",a.""Name"",a.""py"",a.""DepartmentCode""
            ,a.""zc"",a.""HeadIcon""
            ,a.""Gender"" ""IntGender""
            ,a.""Birthday"",a.""MobilePhone"",a.""Email"",a.""WeChat"",a.""ManagerCode"",a.""px"",a.""Description""
            ,a.""CreateTime"",a.""CreatorCode"",a.""LastModifyTime"",a.""LastModifierCode"",a.""zt"" 
, b.""Name"" ""DepartmentName"" 
from ""Sys_Staff"" a left join ""Sys_Department"" b on a.""DepartmentCode"" = b.""Code"" where 1 = 1");
            ...
            var list = this.QueryWithPage<SysStaffVO>(sql.ToString(), pagination, pars == null ? null : pars.ToArray());
            list.ToList().ForEach(p => p.Gender = p.IntGender == 1 ? true : (p.IntGender == 0 ? false : (bool?)null));
            return list;
        }
