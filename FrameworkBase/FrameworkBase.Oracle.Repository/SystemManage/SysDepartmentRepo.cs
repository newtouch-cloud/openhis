...
namespace FrameworkBase.Oracle.Repository
{
    ...
    public sealed class SysDepartmentRepo : RepositoryBase<SysDepartmentEntity>, ISysDepartmentRepo
    {
        ...
        public IList<SysDepartmentEntity> GetList(string keyword = null)
        {
            ...
            sql.Append("select * from \"Sys_Department\" where 1 = 1");
        ...
        {
            var sql = new StringBuilder();
            sql.Append("select * from \"Sys_Department\" where 1 = 1 and \"zt\" = '1'");
            List<OracleParameter> pars = null;
            return this.FindList<SysDepartmentEntity>(sql.ToString(), pars == null ? null : pars.ToArray());
        }
        ...
        {
            var sql = "select \"Name\" from \"Sys_Department\" where \"Code\" = :code";
            return this.FirstOrDefault<string>(sql, new[] { new OracleParameter(":code", code) });
        }
