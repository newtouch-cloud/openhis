...
namespace FrameworkBase.Oracle.Repository
{
    ...
    public sealed class SysUserRoleRepo : RepositoryBase<SysUserRoleEntity>, ISysUserRoleRepo
    {
        ...
        {
            var sql = "select \"UserId\" from \"Sys_UserRole\" where \"RoleId\" = :roleId and \"zt\" = '1'";
            return this.FindList<string>(sql, new OracleParameter[] {
        ...
        {
            var sql = "select \"RoleId\" from \"Sys_UserRole\" where \"UserId\" = :userId and \"zt\" = '1'";
            return this.FindList<string>(sql, new OracleParameter[] {
