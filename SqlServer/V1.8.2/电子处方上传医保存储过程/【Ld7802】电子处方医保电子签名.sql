...
/****** Object:  StoredProcedure [dbo].[usp_ElectronicPrescription_D003_Prescription]    Script Date: 2024/11/11 10:29:13 ******/
SET ANSI_NULLS ON
GO
...
/**
 【Ld7802】电子处方医保电子签名
exec [usp_ElectronicPrescription_D003_Prescription] '6d5752a7-234a-403e-aa1c-df8b45d3469f',
'2410309600005','R20241030N000010','23','23','','',''
select * from Dzcf_D001_output
*/

CREATE proc [dbo].[usp_ElectronicPrescription_D003_Prescription]
	@orgId varchar(500),
	@hisId varchar(500),
	@cfh varchar(500),
...
,d002.rxFile rxFile 	--处方原件 	大文本 	 	 	Y 	医保电子签名后的处方文件base64字符(PDF 或OFD格式) 
,d002.signDigest signDigest 	--处方信息签名值 	字符型 	4000 	 	Y 	医保电子签名后处方信息的签名结果 
,'' extras 	--扩展字段 	JSON 	4000 	 	 	（预留字段，当前未使用），JSON序列化成字符串后长度不能超过4000 
from Dzcf_D001_output D001
--inner join [NewtouchHIS_Sett]..Drjk_mzjs_input ybdj on d001.mzh=ybdj.mzh and ybdj.zt=1
...
left join [NewtouchHIS_Sett]..Dzcf_D002_output d002 on d002.cfh=d001.cfh and d002.zt='1'
