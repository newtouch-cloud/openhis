...
SELECT d.pdh 单据号, d.operateTime 退货时间, d.dlmc 大类名称, d.ypmc 药品名称, d.ypgg 规格, d.Ph 批号
, CONCAT(d.bmsl,d.ckdw) 数量, d.bzdw 单位, CONCAT(d.jj,'元/',d.bzdw) 进价单价
