...
select 8,'其他',80,'其他'  
 ...
 ''resp_nurs_code, a.clr_way ,
  (case when a.clr_way in(1,2,9) then a.clr_way when a.clr_way=3 then 5 when a.clr_way=4 then 6 else 1 end) hi_paymtd, -- 医保支付方式 字符型 3 Y Y    
  ''stas_type,
